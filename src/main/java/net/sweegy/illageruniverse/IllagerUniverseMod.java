...
@Mod("illager_universe")
public class IllagerUniverseMod {
	public static final Logger LOGGER = LogManager.getLogger(IllagerUniverseMod.class);
	public static final String MODID = "illager_universe";

	public IllagerUniverseMod(FMLJavaModLoadingContext context) {
