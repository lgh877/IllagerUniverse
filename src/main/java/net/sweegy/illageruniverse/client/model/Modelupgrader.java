...
public class Modelupgrader<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("illager_universe", "modelupgrader"), "main");
	public final ModelPart body;
	public final ModelPart trueHead;
	public final ModelPart head;
	public final ModelPart mouth;
	public final ModelPart glass;
	public final ModelPart nose2;
	public final ModelPart leg0;
	public final ModelPart leg1;
	public final ModelPart right_arm;
	public final ModelPart hammer;
	public final ModelPart left_arm;
	public final ModelPart wrench;
	public final ModelPart arms;
	public final ModelPart arms_rotation;
	public final ModelPart arms_flipped;
	public final ModelPart none;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 14.0F, 6.0F, new CubeDeformation(0.5F)),
		...
		PartDefinition mouth = head.addOrReplaceChild("mouth", CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, -3.1F));
		PartDefinition glass = head.addOrReplaceChild("glass",
				CubeListBuilder.create().texOffs(32, 8).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.25F)).texOffs(32, 9).addBox(1.0F, 0.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 9)
						.addBox(-3.0F, 0.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 11).addBox(-3.0F, -3.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 11)
						.addBox(1.0F, -3.0F, -5.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 6).addBox(3.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 6)
						.addBox(-4.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 6).addBox(-1.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 6)
						.addBox(0.0F, -2.0F, -5.0F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 13).addBox(1.0F, -2.0F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 13)
						.addBox(-3.0F, -2.0F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -3.0F, 0.0F));
		PartDefinition nose2 = head.addOrReplaceChild("nose2", CubeListBuilder.create().texOffs(24, 0).addBox(-1.0F, -1.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -2.0F, 0.0F));
		...
		PartDefinition hammer = right_arm.addOrReplaceChild("hammer", CubeListBuilder.create().texOffs(56, 56).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 58)
				.addBox(-3.0F, -7.0F, -2.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(24, 58).addBox(-3.0F, -7.0F, 0.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition wrench = left_arm.addOrReplaceChild("wrench",
				CubeListBuilder.create().texOffs(56, 49).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(52, 47).addBox(-2.0F, -4.0F, -1.0F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 46)
						.addBox(1.0F, -7.0F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(40, 46).addBox(-2.0F, -7.0F, -1.0F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 8.0F, 0.0F, 1.5708F, 0.0F, -1.5708F));
		...
		PartDefinition none = partdefinition.addOrReplaceChild("none", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
