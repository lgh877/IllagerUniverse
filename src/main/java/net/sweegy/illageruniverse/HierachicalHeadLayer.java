...
@OnlyIn(Dist.CLIENT)
public class HierachicalHeadLayer<T extends LivingEntity, M extends EntityModel<T> & IHierachicalHeadedModel> extends RenderLayer<T, M> {
	...
	public HierachicalHeadLayer(RenderLayerParent<T, M> p_234829_, EntityModelSet p_234830_, ItemInHandRenderer p_234831_) {
		this(p_234829_, p_234830_, 1.0F, 1.0F, 1.0F, p_234831_);
	}

	public HierachicalHeadLayer(RenderLayerParent<T, M> p_234822_, EntityModelSet p_234823_, float p_234824_, float p_234825_, float p_234826_, ItemInHandRenderer p_234827_) {
		super(p_234822_);
