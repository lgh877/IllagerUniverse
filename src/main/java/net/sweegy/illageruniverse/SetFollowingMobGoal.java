...
public abstract class SetFollowingMobGoal<E extends Mob & IMobFollower> extends Goal {
	...
	public SetFollowingMobGoal(E p_26140_, boolean p_26141_) {
		this(p_26140_, p_26141_, false);
	}

	public SetFollowingMobGoal(E p_26143_, boolean p_26144_, boolean p_26145_) {
		this.mob = p_26143_;
	...
	public boolean canContinueToUse() {
		LivingEntity livingentity = this.mob.getFollowingMob();
		...
		if (livingentity == null) {
			...
			if (team != null && team1 != team) {
				...
				if (this.mob.distanceToSqr(livingentity) > d0 * d0) {
					...
					this.mob.setFollowingMob(livingentity);
					return true;
				}
			}
		}
	...
	public void stop() {
		//this.mob.setFollowingMob((LivingEntity) null);
		this.targetMob = null;
	}
	...
	public SetFollowingMobGoal setUnseenMemoryTicks(int p_26147_) {
