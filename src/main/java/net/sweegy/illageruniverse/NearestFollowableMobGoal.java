...
public class NearestFollowableMobGoal<E extends Mob & IMobFollower, T extends LivingEntity> extends SetFollowingMobGoal<E> {
	...
	public NearestFollowableMobGoal(E p_26060_, Class<T> p_26061_, boolean p_26062_) {
		this(p_26060_, p_26061_, 10, p_26062_, false, (Predicate<LivingEntity>) null);
	}

	public NearestFollowableMobGoal(E p_199891_, Class<T> p_199892_, boolean p_199893_, Predicate<LivingEntity> p_199894_) {
		this(p_199891_, p_199892_, 10, p_199893_, false, p_199894_);
	}

	public NearestFollowableMobGoal(E p_26064_, Class<T> p_26065_, boolean p_26066_, boolean p_26067_) {
		this(p_26064_, p_26065_, 10, p_26066_, p_26067_, (Predicate<LivingEntity>) null);
	}

	public NearestFollowableMobGoal(E p_26053_, Class<T> p_26054_, int p_26055_, boolean p_26056_, boolean p_26057_, @Nullable Predicate<LivingEntity> p_26058_) {
		super(p_26053_, p_26056_, p_26057_);
		this.targetType = p_26054_;
		this.randomInterval = reducedTickDelay(p_26055_);
		this.setFlags(EnumSet.of(Goal.Flag.TARGET));
		this.targetConditions = TargetingConditions.forNonCombat().range(this.getFollowDistance()).selector(p_26058_);
	}
	...
	public void start() {
		this.mob.setFollowingMob(this.target);
		super.start();
	}
