...
public class Modelbombager<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "bombager"), "main");
	...
	private final ModelPart tnt_block;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_armor = body.addOrReplaceChild("body_armor", CubeListBuilder.create().texOffs(0, 38).addBox(
				-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, new CubeDeformation(0.5F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cape = body.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(0, 75).addBox(-4.0F, 0.0F,
				-1.0F, 8.0F, 20.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 4.0F));
		...
		PartDefinition head_armor = head.addOrReplaceChild("head_armor", CubeListBuilder.create().texOffs(32, 0)
				.addBox(-4.0F, -34.0F, -4.0F, 8.0F, 12.0F, 8.0F, new CubeDeformation(0.45F)),
		...
		PartDefinition right_leg = body.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 22).addBox(
		...
		PartDefinition staff = right_arm
				.addOrReplaceChild("staff",
						CubeListBuilder.create().texOffs(56, 38).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 24.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-1.0F, 8.0F, 0.0F, 1.5708F, 0.0F, 0.0F));

		PartDefinition staff_r1 = staff
				.addOrReplaceChild("staff_r1",
						CubeListBuilder.create().texOffs(46, 50).addBox(0.0F, -6.0F, -1.0F, 2.0F, 6.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, 0.9599F));

		PartDefinition staff_r2 = staff.addOrReplaceChild("staff_r2",
				CubeListBuilder.create().texOffs(46, 50).addBox(-2.0F, -6.0F, -1.0F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.0F, 0.0F, -0.9599F));

		PartDefinition tnt = staff.addOrReplaceChild("tnt", CubeListBuilder.create().texOffs(28, 52).addBox(-3.0F,
				-3.0F, -3.0F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -9.0F, 0.0F));

		PartDefinition tnt_block = tnt.addOrReplaceChild("tnt_block", CubeListBuilder.create().texOffs(0, 96)
		...
		PartDefinition right_arm_armor = right_arm.addOrReplaceChild("right_arm_armor", CubeListBuilder.create()
				.texOffs(48, 96).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.25F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition left_arm_armor = left_arm.addOrReplaceChild("left_arm_armor",
				CubeListBuilder.create().texOffs(48, 96).mirror()
